...
const signup = () => {
  ...
  const validatePasswordMatch = (value) => {
    return value === password || "Password and Confirm_Password don't Match";
  };
    ...
    <>
      <div className="flex h-screen items-center justify-center">
        <form
          ...
          className="border border-white px-6 py-3 rounded-lg space-y-3 w-93"
        >
          ...
          <p>
            ...
            <Link
              to={"/login"}
              className="text-blue-600 cursor-pointer underline ml-0.5"
            >
              Login
            </Link>
          </p>
